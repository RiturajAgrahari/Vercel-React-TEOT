...
const MainVideo = () => {
    ...
    const OpenPlayStore = () => {
        window.open("https://play.google.com/apps/internaltest/4699649063886569017", "_blank")
    }
    ...
    return (
        <div className="main_video" id="home">
            ...
            <div className="video_slogan">
                <div className="video_slogan_sub">~ DOWNLOAD NOW ~</div>
                <div className="buttons">
                    ...
                    <div className="download_platforms">
                        <div className="lock_download" onClick={OpenPlayStore}>
